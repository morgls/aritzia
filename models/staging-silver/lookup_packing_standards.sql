...
t_dept as (
select 
    replace(raw_ts.operation, '_standard', '') as operation,
    time_standard
from raw_ts
)
select 
...
from article_dept 
left join t_dept 
on (article_dept.operation = t_dept.operation
